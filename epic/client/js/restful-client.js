...
RCLIENT.Phonebook = function () {
	...
	this.tabCounter = 4;
        ...
        this.service_url = 'https://phonebook.sdcc.bnl.gov/epic/service/index.php';
...
RCLIENT.Phonebook.prototype = {
	...
	display_statistics: function() {
		...
		var selects = '<p>I. ePIC User Group: <ul><li><b>'+num_mem+'</b> members</li><li><b>'+num_inst+'</b> institutions</li><li><b>'+num_cntr+'</b> countries (<b>'+num_reg+'</b> world regions)</li></ul> </p>';
    ...
    display_worldmap: function() {
        ...
        $('body').append('<div id="worldmapdialog" title="ePIC Collaboration, Institution Locations over the World"><div id="worldmap" style="height: 100%; width: 100%"></div></div>');
        ...
        service.map.addLayer(Esri_NatGeoWorldMap);
				...
				var Stamen_Watercolor = new L.TileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.{ext}', {
...
*/
	...
	display_institution_details: function(id) {
		...
		content += '<p style="padding: 5px;">Institution representative(s) on ePIC User Group Council: ';
		var reps = [];
		...
		if ( exofficioreps.length > 0 ) {
			content += '<p style="padding: 5px;">Ex-officio representative(s) on ePIC Collaboration Council: ';
