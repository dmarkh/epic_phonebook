...
style="vertical-align: middle;"> Institutional Board</li>
  ...
  <div class="ui-layout-south ui-widget-header">
    <h4 class="ui-widget-header" style="font-family: 'Oswald', verdana;">ePIC Collaboration, 2023-2024</h4>
  </div>
  ...
  <div class="ui-layout-north">
    ...
    <h3 class="ui-widget-header" style="font-weight: normal; font-size: 24px; color: #5CB8E6; font-family: 'Oswald', verdana;">
		<div style="position: absolute; top: 10px; left: 10px; color: #FFF !important;" ><a href="http://phonebook.sdcc.bnl.gov/epic_admin/"
		style="color: #AAA; text-decoration: none; font-size: 0.8em !important;">[ to ADMIN version ]</a>
		</div>
		<span style="color: #FFFF50;">PhoneBook:</span> ePIC Collaboration
 ...
 <div class="ui-layout-center">
        <div id="tabs">
        	...
        	<div id="tabs-1">
				...
				<p>If you want to become a member of the ePIC collaboration or you have a question about the ePIC phonebook records, please contact the ePIC PhoneBook manager at <a style="text-decoration: underline" href="mailto:arkhipkin@bnl.gov">arkhipkin@bnl.gov</a></p>
            </div>
        </div>
